    ...
    <div className="rounded-lg border border-border bg-surface p-6">
      ...
      <form onSubmit={handleSubmit(submit)} method="post" className="mt-4 space-y-4" noValidate>
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-soft">Para trocar o e-mail, fale com o administrador.</p>
        </div>
        ...
        {saved && !serverError && (
          <p className="rounded-md bg-emerald-50 dark:bg-emerald-500/10 px-3 py-2 text-sm text-emerald-700 dark:text-emerald-400">Dados atualizados.</p>
        )}
  ...
  return (
    <div className="rounded-lg border border-border bg-surface p-6">
      ...
      <form onSubmit={handleSubmit(submit)} method="post" className="mt-4 space-y-4" noValidate>
        ...
        {saved && !serverError && (
          <p className="rounded-md bg-emerald-50 dark:bg-emerald-500/10 px-3 py-2 text-sm text-emerald-700 dark:text-emerald-400">Senha atualizada.</p>
        )}
